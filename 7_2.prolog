...
card_order(SmallerCards, Card, BiggerCards) :- append([SmallerCards,[Card],BiggerCards], ['J', '2', '3', '4', '5', '6', '7', '8', '9', 'T', 'Q', 'K', 'A']).
...
equal_card(Card, 'J', Card) :- card_order(_, Card, _), Card \= 'J'.
equal_card('J', Card, Card) :- card_order(_, Card, _), Card \= 'J'.